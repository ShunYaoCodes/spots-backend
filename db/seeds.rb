...
Location.create({name: "Flatiron School", x_lon: 40.705249, y_lat: -74.014059, street: "11 Broadway #260", city: "New York", state: "NY", zip: "10004"}).categories.create({name: "Cult"})
...
# restaurants
restaurant = Category.create(name: "Restaurant and Bar")
Location.create({name: "Aquavit", x_lon: 40.760923, y_lat: -73.972121, street: "65 E 55th St", city: "New York", state: "NY", zip: "10022"}).categories << restaurant
Location.create({name: "Aska", x_lon: 40.712488, y_lat: -73.966419, street: "47 S 5th St", city: "Brooklyn", state: "NY", zip: "11249"}).categories << restaurant
...
Location.create({name: "Le Bernardin", x_lon: 40.761569, y_lat: -73.981805, street: "155 W 51st St", city: "New York", state: "NY", zip: "10019"}).categories << restaurant
...
Location.create({name: "Jungsik", x_lon: 40.718827, y_lat: -74.009075, street: "2 Harrison St", city: "New York", state: "NY", zip: "10013"}).categories << restaurant
...
Location.create({name: "Masa", x_lon: 40.768414, y_lat: -73.982704, street: "10 Columbus Circle", city: "New York", state: "NY", zip: "10019"}).categories << restaurant
Location.create({name: "The Modern", x_lon: 40.760948, y_lat: -73.976832, street: "9 W 53rd St", city: "New York", state: "NY", zip: "10019"}).categories << restaurant
...
Location.create({name: "Per Se", x_lon: 40.768414, y_lat: -73.982704, street: "10 Columbus Circle", city: "New York", state: "NY", zip: "10019"}).categories << restaurant
...
# movie theaters
movie = Category.create(name: "Movie theaters")
